...
public class Promise<T>{
	...
	private List<callback> subscriptions;
	private T result;

	public Promise() {
		this.resolved = false;
		this.subscriptions = new ArrayList<callback>() {};
		result=null;
	}
	...
	public void resolve(T value){
		if(resolved){
			throw new IllegalStateException("TRIED RESOLVING TWICE");
		}
		result=value;
		resolved=true;

		for (callback callback: subscriptions) {
			callback.call();
		}
	}
